    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            <div class="form-group">
                                <label>Masukan Jumlah Anggota keluarga</label>
            ...
            <div class="col-md-8" style="padding:20px;">
                <div class="card">
                    <div class="card-header badge-primary">Data anggota keluarga</div>
                    <div class="card-body">
                        <form action="prolat1.php" method="post">
                            <?php
                                    ...
                                    <div class="card badge-primary">
                                        ...
                                        <div class="card-body">
                                            <div class="row" style="padding-bottom:20px;">
                                                ...
                                                <div class="col">
                                                    <input type="text" class="form-control" name="kelas[]" placeholder="NIK" required>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <input type="text"  class="form-control" name="n_harian[]" placeholder="Alamat">
                                                </div>
                                                <div class="col">
                                                    <input type="number" min="1" max="100" class="form-control" name="n_uts[]" placeholder="Umur">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
